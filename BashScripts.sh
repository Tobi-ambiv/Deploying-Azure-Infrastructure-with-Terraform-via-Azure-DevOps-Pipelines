...
az keyvault create --name "Ambivkv" --resource-group "Ambiv-infra" --location uksouth
az keyvault secret set --vault-name "Ambivkv" --name "tstateaccess" --value {$ACCOUNT_KEY}
az keyvault secret show --vault-name "Ambivkv" --name "tstateaccess"
